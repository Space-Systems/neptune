...
!$OMP THREADPRIVATE(MN3,ZN3,MN2,ZN2,ZMIX,ALAST,MSSL,SV,/GTS3C/,/MESO7/)
!$OMP THREADPRIVATE(/LOWER7/,/PARM7/,/DATIM7/,/DATIME/,/CSW/,/MAVG7/)
!$OMP THREADPRIVATE(/DMIX/,/PARMB/,/METSEL/)
...
!$OMP THREADPRIVATE(/PARMB/,/METSEL/,BM,RGAS,TEST,LTEST)
      PL=ALOG10(PRESS)
...
!$OMP THREADPRIVATE(/CSW/,IYDL,SECL,GLATL,GLL,STLL,FAL,FL,APL,SWL,SWCL)
      VTST7=0
...
!$OMP THREADPRIVATE(/GTS3C/,/MESO7/,/LOWER7/,/PARM7/,/CSW/,/TTEST/)
!$OMP THREADPRIVATE(/DMIX/,/METSEL/,MT,ALTL,MN1,ZN1,DGTR,DR,ALAST,ALPHA)
C        Test for changed input
...
!$OMP THREADPRIVATE(/TTEST/,/CSW/,/LPOLY/,DGTR,DR,XL,TLL)
!$OMP THREADPRIVATE(SW9,DAYL,P14,P18,P32,HR,SR,SV,NSW,P39)
...
!$OMP THREADPRIVATE(/LPOLY/,/CSW/,DR,DGTR,PSET,DAYL,P32,P18,P14,P39)
...
C       New lower thermo polynomial 10/30/89
      ...
      SAVE
      DATA RGAS/831.4/
!$OMP THREADPRIVATE(/PARMB/,/LSQV/,RGAS)
...
C       Calculate Temperature and Density Profiles for lower atmos.
      ...
      SAVE
      DATA RGAS/831.4/
!$OMP THREADPRIVATE(/PARMB/,/FIT/,/LSQV/,RGAS)
      ZETA(ZZ,ZL)=(ZZ-ZL)*(RE+ZL)/(RE+ZZ)
      DENSM=D0
