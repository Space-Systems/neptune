...
NPI Ephemeris Propagation Tool with Uncertainty Extrapolation is a state of the art numerical orbit propagator. It allows the extrapolation of a state vector and the associated uncertainty forward and backward in time. It regards perturbative forces using
  ...
  * lunar gravity harmonics via the AIUB-GRL350A model (configurable degree 2–350),
  * solar radiation model,
  * Earth albedo model,
  * solid Earth tides model.

NEPTUNE supports propagation of **cislunar and lunar orbiting spacecraft** through Moon-centered reference frame (MCRF) input and output. State vectors and osculating Keplerian elements can be provided and retrieved in selenocentric coordinates (MCRF axes aligned with GCRF; origin at Moon's centre of mass).
...
The project can be adapted in *input/neptune.inp*. The *data* directory contains necessary data that can be retrieved from external sources.
...
| MOON                              | Switch for the perturbations due to Moon's gravity (point-mass third-body). For lunar gravity harmonics, also set OPT\_LUNAR\_GRAV\_DEGREE.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | ON (d), OFF                           | 1\.0.0     |
|   OPT\_LUNAR\_ <br> GRAV\_DEGREE  | Maximum degree of the lunar gravity field model (AIUB-GRL350A) applied to the spacecraft. Set to '0' (default) for point-mass Moon only. Values 2–350 enable the corresponding degree of the selenopotential. Requires MOON to be ON. (*NOTE:* passed as a string.)                                                                                                                                                                                                                                                                                                                                                                                                           | 0 (d), 2, ... 350                     | 1\.2.0     |
...
| OUTPUT\_CSV                       | Switch for the generation of the output file for the cartesian state vector (radius and velocity) in GCRF.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | ON, OFF (d)                           | 1\.0.0     |
|   OUTPUT\_CSV\_ <br> MCRF         | Switch for the generation of the Moon-centered cartesian state vector output file (MCRF). MCRF axes are aligned with GCRF; origin at Moon's centre of mass. File extension: *.mcs*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | ON, OFF (d)                           | 1\.2.0     |
|   OUTPUT\_OSC\_ <br> MCRF         | Switch for the generation of the Moon-centered osculating Keplerian elements output file. Elements are computed using Moon's GM (DE-430). File extension: *.osm*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | ON, OFF (d)                           | 1\.2.0     |
|   OUTPUT\_VAR\_ <br> MCRF         | Switch for the generation of the variances output file in the MCRF frame (diagonal elements of the covariance matrix). Since MCRF is a pure translation of GCRF, values are identical to OUTPUT\_VAR\_ECI.                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | ON, OFF (d)                           | 1\.2.0     |
|   OUTPUT\_COV\_ <br> MCRF         | Switch for the generation of the covariances output file in the MCRF frame (off-diagonal elements). Since MCRF is a pure translation of GCRF, values are identical to OUTPUT\_COV\_ECI.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | ON, OFF (d)                           | 1\.2.0     |
...
For **lunar orbit propagation**, the initial state can be provided in the Moon-centered reference frame (MCRF) by setting the state vector components relative to the Moon's centre of mass. The input type must be specified accordingly via `neptune.inp` (type 6 for MCRF Cartesian, type 7 for MCRF osculating Keplerian elements). MCRF axes are aligned with GCRF; the origin is at the Moon's centre of mass.
